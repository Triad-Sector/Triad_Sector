...
public sealed partial class CryoPodSystem: SharedCryoPodSystem
{
    ...
    private void OnAppearanceChange(EntityUid uid, CryoPodComponent component, ref AppearanceChangeEvent args)
    {
        ...
        if (isOpen)
        {
            ...
            _sprite.SetDrawDepth((uid, args.Sprite), (int) DrawDepth.Mobs); //Mono: Objects >> Mobs: Fix sprite for collisions
        }
        else
        {
            _sprite.SetDrawDepth((uid, args.Sprite), (int) DrawDepth.Mobs);
