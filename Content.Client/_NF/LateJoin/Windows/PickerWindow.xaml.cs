...
using Robust.Shared.Prototypes; // Triad: admin-gated jobs
...
public sealed partial class PickerWindow : FancyWindow
{
    ...
    [Dependency] private IPrototypeManager _prototypes = default!; // Triad: admin-gated jobs
    [Dependency] private JobRequirementsManager _jobReqs = default!; // Triad: admin-gated jobs
    ...
    protected override void EnteredTree()
    {
        ...
        _jobReqs.Updated += OnRequirementsUpdated; // Triad: admin-gated jobs
    }
    ...
    // Triad: the admin-gated jobs a player may take change with their admin rank, which can change while this
    // window is open.
    ...
    {
        // Triad: admin-gated jobs this player cannot take are dropped before anything below counts or shows them.
        obj = AdminGatedJobFilter.Filter(obj, _prototypes, _jobReqs);
