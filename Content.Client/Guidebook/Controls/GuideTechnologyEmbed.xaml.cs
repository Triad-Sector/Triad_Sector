...
public sealed partial class GuideTechnologyEmbed : BoxContainer, IDocumentTag, ISearchableControl
{
    ...
    public bool TryParseTag(Dictionary<string, string> args, [NotNullWhen(true)] out Control? control)
    {
        ...
        {
            Log.Error("Technology embed tag is missing technology prototype argument");
            return false;
        }

        if (!_prototype.TryIndex<TechnologyPrototype>(id, out var technology))
        {
            Log.Error($"Specified technology prototype \"{id}\" is not a valid technology prototype");
            return false;
        }
