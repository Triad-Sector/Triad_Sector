...
namespace Content.Client.Administration.UI.Tabs.AdminbusTab
{
    ...
    public sealed partial class AdminbusTab : Control
    {
        ...
        private readonly TileSpawnUIController _tileSpawningController; // Triad: engine controller draws variant strips whole
        ...
        public AdminbusTab()
        {
            ...
            _tileSpawningController = UserInterfaceManager.GetUIController<TileSpawnUIController>(); // Triad
