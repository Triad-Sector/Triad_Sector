...
using Robust.Client.Graphics; // Triad
...
public sealed partial class NanoChatLookupView : PanelContainer
{
    ...
    {
        // Triad: upstream Delta-V styles the row stripes with StyleClass.PanelDark/PanelLight, which come from the
        // newer upstream stylesheet refactor we have not merged. Paint the stripe directly so it looks right either way.
        private static readonly Color RowDark = StyleNano.PanelDark;
        private static readonly Color RowLight = Color.FromHex("#2A2A2A");
        ...
        public ContactContainer(NanoChatRecipient contact, NanoChatUiState state, bool isEvenRow, Action<NanoChatRecipient>? onStartChat)
        {
            ...
            PanelOverride = new StyleBoxFlat { BackgroundColor = isEvenRow ? RowDark : RowLight };
            // End Triad
            ...
            startChatButton.AddStyleClass(StyleBase.ButtonOpenBoth); // Triad: StyleClass<StyleBase
