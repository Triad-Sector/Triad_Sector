...
public sealed partial class MeleeWeaponSystem
{
    ...
    private Animation GetThrustAnimation(EntityUid uid, SpriteComponent sprite, float distance, Angle spriteRotation)
    {
        ...
        _sprite.SetRotation((uid, sprite), sprite.Rotation + spriteRotation);
