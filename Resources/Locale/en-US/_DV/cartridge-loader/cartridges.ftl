...
# Triad: TriTalk. The keys stay nano-chat-* so the ported Delta-V C# and XAML need no edits and future
# merges stay mechanical. Only the values below are ours, and they are the only part players ever see.
nano-chat-program-name = TriTalk
nano-chat-title = TriTalk
