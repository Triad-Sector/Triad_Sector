...
nf-tips-dataset-27 = When playing in a faction role, remember to communicate with your other members - Coordination saves lives increases immersion, the radio is your best friend!
nf-tips-dataset-28 = As a TDF enforcer, communicating with those in the sector is your best skill for deescalating and resolving conflicts, whilst maintaining sector security.
nf-tips-dataset-29 = As a Mercenary, it's important to take the time to reach out to other players and allow time to socialise.  The game is more fun when you engage with it together and don't play to win.
...
nf-tips-dataset-55 = When dealing with TDF, you may get your sentence reduced through cooperation and/or deception.
...
nf-tips-dataset-64 = Triad is open source! If there's a change you want to make, or a simple item you want to add, then try contributing to the game. It's not as hard as you'd think it is.
...
nf-tips-dataset-94 = The Shipyard Console can rename your shuttle! Plug it in and select the rename option.
...
nf-tips-dataset-98 = Don't forget to inject your medical implant before wandering into deep space! It will send a message to the local medics in the event of your death.
...
nf-tips-dataset-111 = Remember, Venmar Station and Medical Dispatch has a 512m wide safe-zone. It's forbidden to be destructive or damaging in safe zones. Check the rule for more information.
nf-tips-dataset-112 = If you're using an IFF console, remember to turn your IFF on within 500m of the Venmar, or you'll risk facing TDF on your ship!
...
nf-tips-dataset-116 = Every shuttle console has an internal traffic intercom. Make sure to use it to contact the STC before docking with Venmar!
...
nf-tips-dataset-120 = There are multiple ways to earn money. Why not get a job on the Venmar, join the TDF, go salvaging, do science, or do something totally illegal? Other players can teach you each one of them!
