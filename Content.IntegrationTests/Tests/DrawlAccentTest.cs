...
#pragma warning disable RA0002 // poke [Access]-gated tic config for the test
            ...
            var cowboyPrefix = new CowboyAccentComponent
            {
                PrefixProb = 1f,
                SuffixProb = 0f,
                Prefixes = new() { "accent-cowboy-prefix-1" }, // "Howdy,"
            };
#pragma warning restore RA0002
            ...
            Assert.That(drawl.Drawl("I'm thinking", cowboyPrefix), Does.StartWith("Howdy, I'm"));
            ...
            Assert.That(notShout, Does.StartWith("Howdy,"));
            Assert.That(notShout, Does.Not.StartWith("HOWDY"));

            // A genuine shout DOES carry to the prefix.
            var shout = drawl.Drawl("STOP RIGHT THERE", cowboyPrefix);
            Assert.That(shout, Does.StartWith("HOWDY,"));
        });
